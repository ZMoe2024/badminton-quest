'use strict';
(()=>{
 let snapshot={canManage:false,items:[]},editing=null;
 ...
 document.addEventListener('click',ev=>{
  ...
  if(b.id==='notice-close')return $('#notice-dialog').close();
